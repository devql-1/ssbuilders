(function() {
  ...
  var DEFAULTS = {
    ...
    properties: [
      {title: "Luxury 3BHK Apartment", location: "Malviya Nagar, Jaipur", price: "\u20B91.25 Crore", type: "Apartment", beds: 3, baths: 2, area: 1800, description: "Premium 3BHK in heart of Malviya Nagar with modern amenities and clubhouse."},
      {title: "Independent Villa", location: "Vaishali Nagar, Jaipur", price: "\u20B91.08 Crore", type: "Villa", beds: 3, baths: 3, area: 2200, description: "Spacious villa with private garden and gated community security."},
      {title: "2BHK Near Central Park", location: "C-Scheme, Jaipur", price: "\u20B995 Lakh", type: "Apartment", beds: 2, baths: 2, area: 1200, description: "Well-ventilated 2BHK near Central Park with excellent connectivity."},
      {title: "4BHK Penthouse", location: "Mansarovar, Jaipur", price: "\u20B91.42 Crore", type: "Apartment", beds: 4, baths: 4, area: 2400, description: "Luxury penthouse with panoramic city views and smart home features."},
      {title: "Commercial Space", location: "Jhotwara, Jaipur", price: "\u20B972 Lakh", type: "Commercial", beds: 0, baths: 2, area: 900, description: "Prime commercial space on main road with dedicated parking."},
      {title: "Residential Plot", location: "Ajmer Road, Jaipur", price: "\u20B985 Lakh", type: "Plot", beds: 0, baths: 0, area: 1500, description: "Gated community plot with clear title and metro corridor nearby."}
    ]
  };
  ...
  document.getElementById("addPropertyBtn").addEventListener("click", function() { data.properties = data.properties || []; data.properties.push({title:"",location:"",price:"",type:"Apartment",beds:0,baths:0,area:0,description:""}); renderProperties(); });
